...
function calc() {
  var btnChangeScheme = document.querySelector('#btnChangeScheme'),
      ...
      calcForm = document.querySelector('.calc__form'); // получение данных от формы
  ...
  btnChangeScheme.addEventListener('click', function () {
    ...
    calcFormPart1.classList.add('hide'); // getData(selector);
  ...
  sendScheme.addEventListener('click', function () {
    calcFormPart2.classList.add('hide'); // getData(selector);

    setData('.calc__form');
    var userMail = 'test@test.com';
    calcForm.innerHTML = "<h3>\u0420\u0430\u0441\u0447\u0435\u0442 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D \u043D\u0430 \u0443\u043A\u0430\u0437\u0430\u043D\u043D\u0443\u044E \u0432\u0430\u043C\u0438 \u043F\u043E\u0447\u0442\u0443: ".concat(userMail, "</h3>");
  }); //func getData
  //------------------------calc-end---------------------//
}
